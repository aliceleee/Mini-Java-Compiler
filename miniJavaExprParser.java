...
public class miniJavaExprParser extends Parser {
	...
	public static final int
		...
		T__31=32, IDENTIFIER=33, INT=34, WS=35, MULTILINE_COMMENT=36, LINE_COMMENT=37, 
		BOOLEAN=38, RETURN=39;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"WS", "MULTILINE_COMMENT", "LINE_COMMENT", "BOOLEAN", "RETURN"
		};
	}
	...
	public static class MethoddeclarationContext extends ParserRuleContext {
		...
		public TerminalNode RETURN() { return getToken(miniJavaExprParser.RETURN, 0); }
	...
	public static class ArrayTypeContext extends TypeContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof miniJavaExprListener ) ((miniJavaExprListener)listener).enterArrayType(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof miniJavaExprListener ) ((miniJavaExprListener)listener).exitArrayType(this);
		}
	}
	public static class BooleanTypeContext extends TypeContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof miniJavaExprListener ) ((miniJavaExprListener)listener).enterBooleanType(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof miniJavaExprListener ) ((miniJavaExprListener)listener).exitBooleanType(this);
		}
	}
	public static class IntTypeContext extends TypeContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof miniJavaExprListener ) ((miniJavaExprListener)listener).enterIntType(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof miniJavaExprListener ) ((miniJavaExprListener)listener).exitIntType(this);
		}
	}
	public static class IdentifierTypeContext extends TypeContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof miniJavaExprListener ) ((miniJavaExprListener)listener).enterIdentifierType(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof miniJavaExprListener ) ((miniJavaExprListener)listener).exitIdentifierType(this);
		}
	}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 4:
						...
						_errHandler.sync(this);
						_la = _input.LA(1);
						if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__6) | (1L << T__29) | (1L << T__30) | (1L << T__31) | (1L << IDENTIFIER) | (1L << INT) | (1L << BOOLEAN))) != 0)) {
							{
							setState(191);
							expression(0);
							setState(196);
	...
	public static final String _serializedATN =
		...
		"\f\t\16\t\u00c8\13\t\5\t\u00ca\n\t\3\t\7\t\u00cd\n\t\f\t\16\t\u00d0\13"+
		"\t\3\t\2\3\20\n\2\4\6\b\n\f\16\20\2\3\3\2\31\35\2\u00e7\2\22\3\2\2\2\4"+
		...
		"`^\3\2\2\2`a\3\2\2\2ac\3\2\2\2b`\3\2\2\2cd\7)\2\2de\5\20\t\2ef\7\20\2"+
		"\2fg\7\16\2\2g\13\3\2\2\2hi\7\22\2\2ij\7\13\2\2jo\7\f\2\2ko\7\23\2\2l"+
		"o\7\22\2\2mo\7#\2\2nh\3\2\2\2nk\3\2\2\2nl\3\2\2\2nm\3\2\2\2o\r\3\2\2\2"+
		"pt\7\4\2\2qs\5\16\b\2rq\3\2\2\2sv\3\2\2\2tr\3\2\2\2tu\3\2\2\2uw\3\2\2"+
		"\2vt\3\2\2\2w\u009a\7\16\2\2xy\7\24\2\2yz\7\t\2\2z{\5\20\t\2{|\7\r\2\2"+
		"|}\5\16\b\2}~\7\25\2\2~\177\5\16\b\2\177\u009a\3\2\2\2\u0080\u0081\7\26"+
